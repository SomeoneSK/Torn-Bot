...
async function item_bazaar(interaction, item_id, info = false) {
	if (info === false) {
		const url = General_functions.make_url( "market", item_id, ["bazaar"] )
	...
	let market_button = await Components_functions.button(interaction, "market", "Market", "PRIMARY", market)
