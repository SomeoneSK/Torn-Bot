...
var require_function = __commonJS({
  "node_modules/javascript-stringify/dist/function.js"(exports2) {
    ...
    exports2.USED_METHOD_KEY = new WeakSet();
    exports2.functionToString = (fn, space, next, key) => {
...
var require_array = __commonJS({
  "node_modules/javascript-stringify/dist/array.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.arrayToString = (array, space, next) => {
...
var require_object = __commonJS({
  "node_modules/javascript-stringify/dist/object.js"(exports2) {
    ...
    exports2.objectToString = (value, space, next, key) => {
...
var require_stringify = __commonJS({
  "node_modules/javascript-stringify/dist/stringify.js"(exports2) {
    ...
    exports2.toString = (value, space, next, key) => {
      if (value === null)
        return "null";
...
var QuickChart = class {
  ...
  async getShortUrl() {
    ...
    const resp = await import_axios.default.post(`${this.baseUrl}/chart/create`, this.getPostData());
    if (resp.status !== 200) {
  ...
  async toBinary() {
    ...
    const resp = await import_axios.default.post(`${this.baseUrl}/chart`, this.getPostData(), {
